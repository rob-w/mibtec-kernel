...
#define CNT_DMTIMER_VERSION "0.13"
...
static irqreturn_t cnt_dmtimer_trigger_handler(int irq, void *p)
{
	...
	capture[0] = __omap_dm_timer_read(st->capture_timer, OMAP_TIMER_CAPTURE_REG, st->capture_timer->posted);
	capture[1] = __omap_dm_timer_read(st->capture_timer, OMAP_TIMER_CAPTURE2_REG,st->capture_timer->posted);
