...
#define PRU_ADC_MODULE_VERSION "1.95b"
...
static const struct iio_chan_spec_ext_info pru_ext_info[] = {
	...
	IIO_ENUM_AVAILABLE("filter_mode", IIO_SHARED_BY_TYPE, &pru_filter_mode_enum),
	IIO_ENUM("decimation_rate", IIO_SHARED_BY_TYPE, &pru_dec_rate_enum),
	IIO_ENUM_AVAILABLE("decimation_rate", IIO_SHARED_BY_TYPE, &pru_dec_rate_enum),
	{ },
};
